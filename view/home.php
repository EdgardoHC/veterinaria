...
<body>
    ...
    <main class="container mt-5">
        ...
        <div class="row">
            ...
            <a href="index.php?page=raza">Raza</a>
            <a href="index.php?page=padecimientos">Padecimiento</a>
            <a href="index.php?page=vacunas">Vacunas</a>
            <a href="index.php?page=Encargado">Encargado</a>
        </div>
    </main>
